export default function BarChart(container) {
    ...
    function update(data, type, years = listeners.originalYear) {
        ...
        let array_values = sliced_keys.map((e) => {
            return [e, [dataObj[e], tenYears[e], parseInt((dataObj[e] - tenYears[e]) / tenYears[e] * 100)]];
        });
        ...
        bars
            ...
            .on("mouseenter", (event, d) => {
                ...
                d3.select('.tooltip')
                    ...
                    .html(d[0] + "<br>" + "Rounds in " + years + ": " + d[1][0] +
                        "<br>Rounds 10 yrs ago: " + d[1][1] + "<br> Percent Change: " + d[1][2] + "%");
            })
